 ...
 */
final class Version20260404192346 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commission (id INT AUTO_INCREMENT NOT NULL, partner_company VARCHAR(255) NOT NULL, amount INT NOT NULL, date DATETIME NOT NULL, visa_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_1C65015899C772A6 (visa_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE customer (id INT AUTO_INCREMENT NOT NULL, full_name VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, passport_number INT NOT NULL, tazkira_number INT NOT NULL, created_at DATETIME NOT NULL, avatar_image_url VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE commission ADD CONSTRAINT FK_1C65015899C772A6 FOREIGN KEY (visa_id) REFERENCES visa (id)');
