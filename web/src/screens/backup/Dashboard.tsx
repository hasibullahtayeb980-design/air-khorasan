...
import { Table02DividerLine } from '../../components/table-tickets-view-all';
import { Table03DividerLine } from '../../components/visa';
...
export const SidebarSectionDividersDemo = () => <SidebarNavigationSectionDividers activeUrl="/visa-processing" items={navItemsWithDividers} />;
  ...
  return (
      ...
      <div className="light-mode fixed inset-0 z-50 flex min-h-dvh w-full items-end justify-center bg-overlay/70 px-4 outline-hidden backdrop-blur-[6px] sm:items-center sm:justify-center sm:px-8 pt-(--modal-pt) pb-(--modal-pb) [--modal-pb:clamp(16px,8vh,64px)] [--modal-pt:16px] sm:[--modal-pb:32px] sm:[--modal-pt:32px]">
        <div className="rounded-xl bg-primary align-middle shadow-xl outline-hidden max-sm:overflow-y-auto sm:rounded-2xl max-h-[calc(var(--visual-viewport-height)-var(--modal-pt)-var(--modal-pb))] sm:max-w-160">
            <section className="relative max-h-[inherit] w-full overflow-y-auto outline-hidden">
                <button className="flex cursor-pointer items-center justify-center rounded-lg p-2 transition duration-100 ease-linear focus:outline-hidden size-9 text-fg-quaternary hover:bg-primary_hover hover:text-fg-quaternary_hover focus-visible:outline-2 focus-visible:outline-offset-2 outline-focus-ring absolute top-3 right-3 sm:top-4 sm:right-4">
                ...
                <div className="relative">
                    <div className="flex flex-col gap-4 px-4 pt-5 sm:px-6 sm:pt-6">
                        ...
                        <div className="z-10 flex flex-col gap-0.5"><h2 id="react-aria6042599094-_r_1_" slot="title" className="text-md font-semibold text-primary">Add customer</h2><p className="text-sm text-tertiary">Add a new customer to your database.</p></div>
                    </div>
    ...
    />
                                            ...
                                            <div className="relative flex w-full items-center">
                                                <input aria-autocomplete="list" placeholder="Customer's phone number" id="react-aria6042599094-_r_d_" aria-labelledby="react-aria6042599094-_r_e_" role="combobox" aria-expanded="false" className="z-10 w-full appearance-none bg-transparent text-transparent caret-alpha-black/90 placeholder:text-placeholder focus:outline-hidden disabled:cursor-not-allowed text-md" data-rac="" type="text" value="" title="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    />
                                            ...
                                            <div className="relative flex w-full items-center">
                                                <input aria-autocomplete="list" placeholder="Enter Passport Number" id="react-aria6042599094-_r_t_" aria-labelledby="react-aria6042599094-_r_u_" role="combobox" aria-expanded="false" className="z-10 w-full appearance-none bg-transparent text-transparent caret-alpha-black/90 placeholder:text-placeholder focus:outline-hidden disabled:cursor-not-allowed text-md" data-rac="" type="text" value="" title="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    />
                                            ...
                                            <div className="relative flex w-full items-center">
                                                <input aria-autocomplete="list" placeholder="Enter Tazkira Number" id="react-aria6042599094-_r_t_" aria-labelledby="react-aria6042599094-_r_u_" role="combobox" aria-expanded="false" className="z-10 w-full appearance-none bg-transparent text-transparent caret-alpha-black/90 placeholder:text-placeholder focus:outline-hidden disabled:cursor-not-allowed text-md" data-rac="" type="text" value="" title="" />
                                            </div>
                                        </div>
                                    </div>
                            </div>
