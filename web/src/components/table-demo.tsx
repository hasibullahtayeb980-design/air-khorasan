    ...
    return (
        <TableCard.Root>
            ...
            <Table aria-label="Team members" selectionMode="multiple" sortDescriptor={sortDescriptor} onSortChange={setSortDescriptor}>
                <Table.Header>
                    <Table.Head id="name" label="Full Name" isRowHeader allowsSorting className="w-full max-w-1/4" />
                    <Table.Head id="status" label="Phone" allowsSorting />
                    <Table.Head id="email" label="Email address" allowsSorting className="md:hidden xl:table-cell" />
                    <Table.Head id="role" label="Passport Number" allowsSorting tooltip="This is a tooltip" />
                    <Table.Head id="teams" label="Tazkira Number" />
